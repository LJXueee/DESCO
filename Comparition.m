classdef Comparition
    ...
    methods
        % varargin = [sub.newpath],[sub.newmodel]
...
%                 选择默认模型进行代码生成。
            ...
            if nargin>2
                ...
                obj.seedmodelpath = seedmodelpath; % F:\Simulink\C2C-Testing-main\C2C-Testing-main\corpus_seed\sampleModel1077.slx
                obj.seedmodelname = seedmodelname(1:end-4); % sampleModel1077
                addpath(seedmodelpath)
                catchpath = ['.\result\diff\',seedmodelname];
                decdir = strcat(catchpath,'\');
                load_system(seedmodelpath)
